...
class OPdata1DecryptTestCase(T.TestCase):
    ...
    MASTER_KEY = '\x8c\r\x8d\xb6p\xb0\xb7\xd5l\xb1\x1aF5w\xe1A\x03W4@\x80\xb9\xae\xec!Q\x19\x1c\xf3\xde\xc5\x9d'
    MASTER_HMAC = '\xc9S\x10w\xbf|g\xb3\x1aI\xa7\x13\x93\xcf\xd6v_,\x9a\xd8"\xc9\xa8\x8ctX\x1d>k\xe8\xf6V'
    ...
    def test_master_key_decryption(self):
        ...
        T.assert_equal(master_key, self.MASTER_KEY)
        T.assert_equal(master_hmac, self.MASTER_HMAC)
